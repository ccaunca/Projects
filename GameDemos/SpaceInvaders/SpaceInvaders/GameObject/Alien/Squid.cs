...
namespace SpaceInvaders
{
    ...
    {
        public Squid(GameObjectName goName, SpriteBaseName spriteName, float x, float y, int idx)
            : base(goName, spriteName, AlienType.Squid, idx)
        {
            this.x = x;
            this.y = y;
        }
